  ...
  return (
    <div className="h-screen bg-black">
      ...
      <div className="relative">
        ...
        {/* Content */}
        <div className="relative z-10 py-12 md:py-20 border-b border-green-500/20 mt-[100px]">
          <div className="container mx-auto px-4 py-12">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-zinc-400 mb-8 animate-slide-up stagger-delay-1">
                Design your perfect garden with AI-powered tools and expert
                guidance
              </p>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div
          ref={featuresRef}
          className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 section-fade-in"
        >
          {[
            {
              icon: Sprout,
              ...
              description:
                "Easily design your garden layout with intuitive drag and drop tools",
            },
            {
              icon: ShieldCheck,
              title: "AI-Powered Protection",
              description:
                "Detect and prevent plant diseases and weeds with advanced AI",
            },
            {
              icon: Leaf,
              title: "Smart Recommendations",
              description:
                "Get personalized plant grouping and care recommendations",
            },
          ].map((feature, index) => (
            <Card
              key={index}
              className="bg-zinc-900 border-green-500/20 hover:border-green-500/40 hover:shadow-lg hover:shadow-green-500/10 transition-all hover-scale"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="p-4 text-left">
                ...
                <p className="text-lg md:text-xl text-zinc-300 mb-8 leading-relaxed">
                  Keep your garden healthy with AI-powered weed detection and
                  smart notifications. Get real-time alerts and personalized
                  recommendations for your garden's needs.
                </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Drag and drop plants onto the grid to create your garden layout",
                  },
                  {
                    title: "Group Plants",
                    description:
                      "Create plant groupings by clicking and dragging selections",
                  },
                  {
                    title: "Fine-tune",
                    description:
                      "Adjust your design and get AI-powered recommendations",
                  },
                ].map((step, index) => (
        ...
        <div
          id="planner"
          ref={plannerRef}
          className="scroll-mt-16 section-fade-in"
        >
